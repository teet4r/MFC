...
void CSearchFileDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BUTTON2, m_btn_search);
}
...
*/
	...
	m_lstResult.InsertColumn(0, _T("위치"), LVCFMT_LEFT, 150);
	m_lstResult.InsertColumn(0, _T("크기(byte)"), LVCFMT_RIGHT, 80);
	m_lstResult.InsertColumn(0, _T("생성날짜"), LVCFMT_CENTER, 80);
